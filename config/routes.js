...
module.exports.routes = {
  ...
  'get /user/initadmin': 'UserController.initAdminUser',
  ...
  'get /territory/actions/clearmistakes' : 'TerritoryController.clear_mistakes',
  ...
  'post /territory/actions/update/:id' : 'TerritoryController.update',
  'get /territory/actions/holder' : 'TerritoryController.holder',
  'post /territory/actions/holder' : 'TerritoryController.holder',
  'put /territory/:id' : 'TerritoryController.update',
  'get /territory/:letter' : 'TerritoryController.find',
  'get /territory/:letter/:number' : 'TerritoryController.find',
