	      ...
	      return res.view({
	        ...
	        actionResult : "Please input new user information."
				...
				User.find({username : req.body.input_username}).exec(function(err, u) {
					...
					var user_type = req.body.input_type;
					if(req.body.input_holderRelated == 'input_holderRelated') {
					...
					User.create(
						{
							...
							holderRelated:(req.body.input_holderRelated == 'input_holderRelated') ? true : false,
							relatedHolder:req.body.input_relatedHolder,
							type:user_type
						}
					).done(function(err, u){
						return res.view({
